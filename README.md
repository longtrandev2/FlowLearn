...
* **Smart Document Processing**: Tự động trích xuất nội dung từ PDF, DOCX, PPTX và lưu trữ an toàn trên **Cloudflare R2**.
...
* **Core**: Java 21, Spring Boot 4.x, Spring Security.
...
* **Payments**: Stripe API.
* **Messaging**: Gmail SMTP (Auth & Notifications).
